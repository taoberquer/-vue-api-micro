 ...
 */
final class Version20220213195451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE piece ADD CONSTRAINT FK_44CA0B238EB47040 FOREIGN KEY (order_from_id) REFERENCES `order` (id)');
